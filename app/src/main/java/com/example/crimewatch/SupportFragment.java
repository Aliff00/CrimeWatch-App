...
public class SupportFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        View.OnClickListener OCLEmergency = new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.SupportEmergency);
            }
        };
        BtnEmergency.setOnClickListener(OCLEmergency);
    }
}